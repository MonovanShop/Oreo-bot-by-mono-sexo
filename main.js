...
mobile: MethodMobile, 
browser: opcion == '1' ? ['MonkeyBot', 'Edge', '20.0.04'] : methodCodeQR ? ['MonkeyBot', 'Edge', '20.0.04'] : ["Ubuntu", "Chrome", "20.0.04"],
auth: {
creds: state.creds,
...
(async () => {
global.conns = [];
const mainBotAuthFile = 'MonkeyBot';
try {
...
const directories = ['./MonkeyBot/', './GataJadiBot/']
