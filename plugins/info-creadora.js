...
description = official[0][0] == String(contact[0]) ? 'Solo temas de MonkeyBot' : official[1][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : official[2][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : official[3][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : desc === '' ? lenguajeGB.smsContacto5() : desc
correo = official[0][0] == String(contact[0]) ? 'https://chat.whatsapp.com/JGIxAhGuOeiJe2IlR04ZWj' : official[1][0] == String(contact[0]) ? 'https://chat.whatsapp.com/JGIxAhGuOeiJe2IlR04ZWj' : official[2][0] == String(contact[0]) ? 'https://chat.whatsapp.com/JGIxAhGuOeiJe2IlR04ZWj' : mail === '' ? lenguajeGB.smsContacto6() : mail
lugar = official[0][0] == String(contact[0]) ? 'MonkeyBot' : official[1][0] == String(contact[0]) ? 'MonkeyBot' : official[2][0] == String(contact[0]) ? 'MonkeyBot' : official[3][0] == String(contact[0]) ? 'MonkeyBot' : country === '' ? lenguajeGB.smsContacto7() : country
enlace = official[0][0] == String(contact[0]) ? 'https://chat.whatsapp.com/JGIxAhGuOeiJe2IlR04ZWj' : official[1][0] == String(contact[0]) ? 'https://chat.whatsapp.com/JGIxAhGuOeiJe2IlR04ZWj' : official[2][0] == String(contact[0]) ? 'https://chat.whatsapp.com/JGIxAhGuOeiJe2IlR04ZWj' : official[3][0] == String(contact[0]) ? 'https://chat.whatsapp.com/JGIxAhGuOeiJe2IlR04ZWj' : md 

lista.push([number, ofc, nombre, description, official[3][0] == String(contact[0]) ? null : correo, lugar, enlace, bio, official[1][0] == String(contact[0]) ? 'https://chat.whatsapp.com/JGIxAhGuOeiJe2IlR04ZWj' : null]) }  
lista.push([conn.user.jid.split('@')[0], await conn.getName(conn.user.jid), packname, lenguajeGB.smsContacto8(), mail === '' ? 'https://chat.whatsapp.com/JGIxAhGuOeiJe2IlR04ZWj' : mail, lenguajeGB.smsContacto7(), md, bioBot, yt, ig, fb, paypal, nna])
await conn.sendFile(m.chat, pp, 'lp.jpg', cat, fkontak, false, { contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' MonkeyBot ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb.getRandom()}}})
